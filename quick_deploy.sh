...
# ChemFactory MES/ERP Quick Production Deployment
# Simplified version for current environment

echo "🚀 ChemFactory MES/ERP Quick Production Deployment"
echo "=================================================="
